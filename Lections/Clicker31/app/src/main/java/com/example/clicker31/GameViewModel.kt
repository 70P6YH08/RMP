...
class GameViewModel(app: Application) : AndroidViewModel(app){
    ...
    var upgrades = mutableStateMapOf(
        ...
        UpgradeType.ClickMultiplier to Upgrade(
            ...
            baseValue = BigDecimal(1.0),
            valueMultiplier = BigDecimal(13.05)
        ),
    ...
    fun onAutoClick(){
        score+= upgrades[UpgradeType.AutoClick]?.currentValue() ?: BigDecimal(0.0)
    }
    ...
    suspend fun calculateOfflineIncome() : Deferred<BigDecimal> {
        return viewModelScope.async {
            var cap = upgrades[UpgradeType.OfflineIncome]!!.currentValue()
            ...
            if (cap > BigDecimal(0)) {
                ...
                var income = BigDecimal(delta)*upgrades[UpgradeType.AutoClick]!!.currentValue()
